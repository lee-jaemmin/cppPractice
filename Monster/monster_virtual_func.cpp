...
public:
    virtual void special_attack(player target_player) override; // 가상 함수 오버리이드 선언
};
...
int main()
{
    ...
    mon.special_attack(player_1); // mon은 부모 클래스를 참조 하였으나, 결과는 자식 클래스의 인텡글 공격이 출력. 
